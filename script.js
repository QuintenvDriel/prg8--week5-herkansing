...
function buttonAHandler(e) {
    e.preventDefault()
    machine.learn(predictionsArray,'duim')
    console.log('duim')
}

function buttonBHandler(e) {
    e.preventDefault()
    machine.learn(predictionsArray, 'high-five')
    console.log('high-five')
}

console.log(predictLandmarks())



function logData(predictions) {

    buttonA.addEventListener("click", (event) => buttonAHandler(event, predictions));
    buttonB.addEventListener("click", (event) => buttonBHandler(event, predictions));
    ...
    // let topThumb = predictions[0].landmarks[4][1]
    // let bottomIndex = predictions[0].landmarks[5][1]
    // console.log(topThumb, bottomIndex)
    // if (topThumb > bottomIndex) {
    //     log.innerHTML = "B"
    // } else {
    //     log.innerHTML = "niet B"
    // }
}
